...
class ResourcesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resource" do
    assert_difference('Resource.count') do
      post resources_url, params: { resource: { name: @resource.name, regen_time: @resource.regen_time } }
    end
  ...
  test "should update resource" do
    patch resource_url(@resource), params: { resource: { name: @resource.name, regen_time: @resource.regen_time } }
