...
class UserResourcesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_resource" do
    assert_difference('UserResource.count') do
      post user_resources_url, params: { user_resource: { quantity: @user_resource.quantity, resource_id: @user_resource.resource_id, user_id: @user_resource.user_id } }
    end
  ...
  test "should update user_resource" do
    patch user_resource_url(@user_resource), params: { user_resource: { quantity: @user_resource.quantity, resource_id: @user_resource.resource_id, user_id: @user_resource.user_id } }
