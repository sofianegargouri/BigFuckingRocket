...
gold = Resource.create!(name: 'Gold', regen_time: 80)
diamond = Resource.create!(name: 'Diamond', regen_time: 100)
stone = Resource.create!(name: 'Stone', regen_time: 30)
...
PartCost.create!(part: part, resource: gold, cost: 20)
PartCost.create!(part: part, resource: diamond, cost: 10)
PartCost.create!(part: part, resource: stone, cost: 5)
...
PartCost.create!(part: part, resource: gold, cost: 20)
PartCost.create!(part: part, resource: diamond, cost: 5)
PartCost.create!(part: part, resource: stone, cost: 0)
...
PartCost.create!(part: part, resource: iron, cost: 0)
PartCost.create!(part: part, resource: gold, cost: 10)
PartCost.create!(part: part, resource: diamond, cost: 5)
PartCost.create!(part: part, resource: stone, cost: 15)
PartStat.create!(part: part, stat: aero, ratio: 15)
...
PartCost.create!(part: part, resource: iron, cost: 0)
PartCost.create!(part: part, resource: gold, cost: 30)
PartCost.create!(part: part, resource: diamond, cost: 15)
PartCost.create!(part: part, resource: stone, cost: 10)
PartStat.create!(part: part, stat: aero, ratio: 0)
PartStat.create!(part: part, stat: stab, ratio: 5)
